		...
		<div class="homeitem">
			...
			<ul>
				<li>
					...
					<h4><img border=0 src="images/feature.gif">&nbsp;<i><font size=+2>Mylar 1.0 released!</font></i></h4></a>(Dec 11, 2006)
					<br>
					<a href="http://eclipse.org/mylar/doc/release-1.0.php">Read About Mylar 1.0...</a>
				</li>
				<li>
