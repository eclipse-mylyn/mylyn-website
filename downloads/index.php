		...
		<div class="homeitem3col" style="margin-left:40px; width:75%">
			...
			<ul> 
				<li>
					...
					&nbsp;&nbsp;<b>download.eclipse.org/tools/mylyn/update/weekly/e3.4</b>&nbsp;&nbsp;(Eclipse 3.5, 3.6, 3.7)
				</li>
				<li>
					...
					&nbsp;&nbsp;<b>download.eclipse.org/tools/mylyn/update/weekly/incubator</b>&nbsp;&nbsp;(Eclipse 3.5, 3.6, 3.7)
				</li>
			</ul>
		</div>
