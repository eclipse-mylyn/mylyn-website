...
<div id="maincontent">
	...
	<div id="rightcolumn">
		<div class="sideitem">
			...
			<ul>
				<li><a href="dl.php">Mylar 0.4.0</a><span class="dates"> (Oct. 28, 2005)</span></li>
			</ul> 
		</div> 
		<div class="sideitem">
			<h6>News</h6>
			<ul>
				<li>Eugene Kuleshov: <a href="http://jroller.com/page/eu?entry=the_most_addictive_eclipse_plugin">The most addictive Eclipse plugin ever</a><span class="dates"> (Nov. 1, 2005)</span><br>&nbsp;</li>
				<li>Ed Burnette: <a href="http://www.eclipsezone.com/eclipse/forums/t20933.html">Mylar is the next killer app for Eclipse</a><span class="dates"> (July 28, 2005)</span><br>&nbsp;</li>
				<li>User study started<span class="dates"> (July 11, 2005)</span><br>&nbsp;</li>
