...
$html = <<<EOHTML
	...
	<div style="margin-left:10px; margin-top:20pt;">
        	<div style="float:right; margin-right: 30pt; margin-left: 10pt;"><img src="/mylyn/images/install-overview.gif"/></div>
				...
				<div style="margin-top:30pt;">
			        ...
			        <br>&nbsp;<br><b>New users</b>: you can download Mylyn in most of the <a href="http://www.eclipse.org/downloads/">Eclipse Bundles</a>
			        </p>
    			</div>
	</div>		
    ...
    <div class="homeitem3col" style="margin-left:40px; width:90%">
		...
		<br>&nbsp;&nbsp;&nbsp;Released 2007-09-27. Requires <a href="http://java.sun.com/j2se/1.5.0/download.jsp">JRE 5.0</a>. Supports <a href="http://www.bugzilla.org/">Bugzilla</a> 2.18 and later, <a href="http://trac.edgewall.org/">Trac</a> 0.9 and later.				
		<ul>
			<li>
