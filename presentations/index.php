		...
		<div class="homeitem3col">
			...
			<ul>
				<li>
					...
					<a href="/mylyn/presentations/2007-07-eclipse-mylyn-webinar.ppt"><img border=0 src="/mylyn/images/icon-ppt.gif"></a>
                    <a href="http://live.eclipse.org/node/314">Eclipse 3.3 and Mylyn 2.0: Taking the Java IDE to the Next Level</a> by Mik Kersten (July 2007, 55 min)
                </li> 
				<li>
