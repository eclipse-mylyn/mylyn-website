<?php
	...
	<div class="sideitem">
		...
		<ul>
			<li><a href="doc/new.php">Mylar 0.5.1</a><br><span class="dates"> 
			(April 28, 2006)</span><br>&nbsp;</li>
			<li>
			...
			Vote for connectors</a> if your repository is not supported&nbsp;<img border=0 src="images/vote.gif">
		</ul> 
	</div> 
EOHTML
