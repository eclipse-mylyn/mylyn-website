...
$html = <<<EOHTML
    ...
    <div class="homeitem3col" style="margin-left:40px; width:90%">
		...
		<br>&nbsp;&nbsp;&nbsp;Released 2007-09-27: <a href="http://www.eclipse.org/mylyn/new">New & Noteworthy</a>. Requires <a href="http://java.sun.com/jnull: New Task2se/1.5.0/download.jsp">JRE 5.0</a>. Supports <a href="http://www.bugzilla.org/">Bugzilla</a> 2.18 and later, <a href="http://trac.edgewall.org/">Trac</a> 0.9 and later.				
		<ul>
			<li>
    ...
    <div class="homeitem3col" style="margin-left:40px; width:90%">
		...
		<br>&nbsp;&nbsp;&nbsp;Released every Wednesday: <a href="http://www.eclipse.org/mylyn/new/new-dev.html">New & Noteworthy</a>.  Weekly builds are production quality, but subject to UI changes.
		<ul>
			<li>
