	...
	<!-- Release -->
		 <div class="homeitem3col" style="margin-left:40px; width:75%">
			...
			<ul> 
				...
				<li> 
					<a title="Update Site Zip" href="http://www.eclipse.org/downloads/download.php?file=/tools/mylyn/update/mylyn-3.1.0-e3.3.zip">
						<img border=0 src="/mylyn/images/icon-save.gif">
					</a>
					&nbsp;&nbsp;<b>download.eclipse.org/tools/mylyn/update/e3.3</b>&nbsp;&nbsp;(Eclipse 3.3)
				</li>
				<li>
					<a title="Update Site Zip" href="http://www.eclipse.org/downloads/download.php?file=/tools/mylyn/update/mylyn-3.1.0-extras.zip">
						<img border=0 src="/mylyn/images/icon-save.gif">
					</a>
				...
				<li>
					<a title="Update Site Zip" href="http://www.eclipse.org/downloads/download.php?file=/tools/mylyn/update/mylyn-3.1.0-incubator.zip">
						<img border=0 src="/mylyn/images/icon-save.gif">
					</a>
		...
		<div class="homeitem3col" style="margin-left:40px; width:75%">
	    	<a name="weekly"></a>
			<h3>3.2 Weekly Builds&nbsp;<a title="More Info" href="http://wiki.eclipse.org/index.php/Mylyn/User_Guide#Installation"><img border=0 src="/mylyn/images/icon-help.gif"></a></h3> 
			<br>&nbsp;&nbsp;&nbsp;<a href="http://www.eclipse.org/mylyn/new/weekly.php"><img src="/mylyn/images/star.png"/> New & Noteworthy</a> Weekly (Wednesdays) builds are production quality, but subject to UI changes.
			<ul> 
				<li>
