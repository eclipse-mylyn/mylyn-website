		 ...
		 <div class="homeitem3col" style="margin-left:40px; width:75%">
			...
			<ul> 
				<li>
					...
					&nbsp;&nbsp;<b><font color="#666666">http://</font>download.eclipse.org/mylyn/releases/latest</b>&nbsp;&nbsp;(Eclipse 3.7, 3.8 and 4.2)
				</li>
			</ul>
		</div>
