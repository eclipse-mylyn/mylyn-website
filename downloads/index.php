...
$html = <<<EOHTML
	...
	<!-- Release -->
		 <div class="homeitem3col" style="margin-left:40px; width:75%">
			<h3>3.4.1 Release&nbsp;<a title="More Info" href="http://wiki.eclipse.org/index.php/Mylyn/FAQ#Installation"><img border=0 src="/mylyn/images/icon-help.gif"></a></h3> 
			...
			<ul> 
				<li>
					<a title="Update Site Zip" href="http://www.eclipse.org/downloads/download.php?file=/tools/mylyn/update/mylyn-3.4.1-e3.4.zip">
						<img border=0 src="/mylyn/images/icon-save.gif">
					</a>
					&nbsp;&nbsp;<b>download.eclipse.org/tools/mylyn/update/e3.4</b>&nbsp;&nbsp;(Eclipse 3.4, 3.5, 3.6)
				</li>
				<li>
					<a title="Update Site Zip" href="http://www.eclipse.org/downloads/download.php?file=/tools/mylyn/update/mylyn-3.4.1-incubator.zip">
						<img border=0 src="/mylyn/images/icon-save.gif">
					</a>
		...
		<div class="homeitem3col" style="margin-left:40px; width:75%">
			...
			<ul> 
				<li>
					...
					&nbsp;&nbsp;<b><font color="#666666">http://</font>download.eclipse.org/tools/mylyn/update/weekly</b>&nbsp;&nbsp;(Eclipse 3.5, 3.6, 3.7)
				</li>
				<li>
					...
					&nbsp;&nbsp;<b><font color="#666666">http://</font>download.eclipse.org/tools/mylyn/update/weekly/incubator</b>&nbsp;&nbsp;(Eclipse 3.5, 3.6, 3.7)
				</li>
			</ul>
		</div>
