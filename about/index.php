...
<div id="maincontent">
	...
	<div id="midcolumn">
		...
		<div class="homeitem3col">
			...
			<ul>
				<li>
					Mylyn was created by <a target="_blank" href="http://en.wikipedia.org/wiki/Mik_Kersten"><img border="0" src="/mylyn/images/external-link.png"> Mik Kersten</a> as a part of his PhD thesis, supervised by Gail Murphy at the Software Practices Lab at UBC.  Tasktop Technologies was founded by the creators of Mylyn in order to lead the open source project, provide commercial support and extensions, and enable the rapidly growing ecosystem of tools built on Mylyn.
				</li>
				<li>
					Background on Mylyn technology, including research papers, is available at <a target="_blank" href="http://www.tasktop.com/resources/technology/">tasktop.com</a>. 
				</li>
			</ul>
		</div>
